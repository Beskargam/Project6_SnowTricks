 ...
 */
final class Version20181205165134 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_C53D045FB281BE2E ON image');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C53D045FB281BE2E ON image (trick_id)');
